...
function RecipeCard({ recipe }) {
    return (
        <div className='bg-[#3c4f43] flex flex-col gap-1 rounded-xl cursor-pointer hover:-translate-y-1'>
            <div className='w-[full] relative'>
                <img src={recipe.image} className='max-w-full max-h-full rounded-t-xl' />
